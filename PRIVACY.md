# Privacy Policy — Config Secrets File Companion

**Effective date:** 2026-09-07

Config Secrets File Companion is a Gap Hunter Labs extension for Visual Studio Code. This
...
**Nothing.** Config Secrets File Companion does not collect, store, transmit, or sell any
...
**None.** Config Secrets File Companion makes zero network calls during normal operation.
...
None. Config Secrets File Companion has no third-party SDKs, no analytics libraries, no
